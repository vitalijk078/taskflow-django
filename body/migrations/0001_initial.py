# Generated by Django 5.2.10 on 2026-03-13 21:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('user', 'Пользователь'), ('admin', 'Администратор')], max_length=20, unique=True, verbose_name='Роль')),
            ],
            options={
                'verbose_name': 'Роль',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='body.role', verbose_name='Роль')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tasks', to='body.taskcategory', verbose_name='Категория')),
            ],
            options={
                'verbose_name': 'Задача',
